...
import com.sambre.entities.user.CandidateRepository;
import com.sambre.mapper.user.CandidateMapper;
...
public class CandidateService {
    ...
    public List<CandidateResponse> findByExperienceTitleKeyword(String keyword) {
        return candidateRepository.findByExperienceTitleKeyword(keyword)
                .stream()
                .map(candidateMapper::toCandidateResponse)
                .collect(Collectors.toList());
    }
